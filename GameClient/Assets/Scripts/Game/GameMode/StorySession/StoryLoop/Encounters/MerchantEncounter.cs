...
namespace Game.GameMode.StorySession.StoryLoop.Encounters
{
    public abstract class MerchantEncounter : Encounter
    {
        ...
        [field: SerializeField] public AssetReferenceSprite MerchantPortrait;
        ...
        public abstract UniTask<List<string>> GetItemList(IStoryContext storyContext, CancellationToken cancellationToken);
