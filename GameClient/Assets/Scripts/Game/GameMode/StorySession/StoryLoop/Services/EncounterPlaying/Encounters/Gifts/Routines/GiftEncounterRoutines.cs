...
{
    public class GiftEncounterRoutines : IGiftEncounterRoutines
    {
        private IItemPresenter _itemPresenter;
        private GameBoardHolder _gameBoardHolder;

        public GiftEncounterRoutines(
        ...
        public async UniTask ShowElements(GiftEncounter encounter, CancellationToken cancellationToken)
        {
            Sprite portrait = await encounter.GiftEncounterPortrait.Load<Sprite>(cancellationToken);
        ...
        public async UniTask ShowWares(IEnumerable<string> items, CancellationToken cancellationToken)
        {
