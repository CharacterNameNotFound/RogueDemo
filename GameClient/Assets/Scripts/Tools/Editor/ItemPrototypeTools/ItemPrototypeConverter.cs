...
namespace Tools.Editor.ItemPrototypeTools
{
    public class ItemPrototypeConverter : EditorWindow
    {
        ...
        private void ProcessPrefab(GameObject prefab, string path, JsonSerializerSettings settings)
        {
            ...
            {
                Debug.LogError($"Prefab with name \"{prefab.name}\" missing \"ItemCore Component\"");
            }
            ...
            {
                Debug.LogError($"Prefab with name \"{prefab.name}\" missing \"UniversalStatRegisterer Component\"");
            }
            ...
            {
                Debug.LogError($"Prefab with name \"{prefab.name}\" missing \"TagListPrototype Component\"");
            }
